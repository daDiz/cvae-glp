...
event_path = './data/seq_ts%s_valid.pickle' % (ts)
author_path = './data/seq_email_ts%s_valid.pickle' % (ts)
seqlen_path = './data/seq_len_ts%s_valid.pickle' % (ts)
...
with tf.Session() as sess:
    ...
    with open('./results/hit_ts%s_hd%s_lr%s_valid.txt' % (ts, hd, lr), 'w') as file:
        for top_k in top:
