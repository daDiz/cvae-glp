##############################################################
# sum pair-wise preferential for group preferential
###############################################################
...
#########################################
parser = argparse.ArgumentParser(description='preferential attachment')
            ...
            for b in range(n):
                if b not in group:
                    ...
                    if k in cn_dict:
                        ...
                        pa = [x for x in nx.preferential_attachment(g,[(a,b)])]
                        cn = pa[0][2]
                        cn_dict[k] = cn
